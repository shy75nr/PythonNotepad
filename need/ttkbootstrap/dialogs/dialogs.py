...
class MessageDialog(Dialog):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if buttons is None:
            self._buttons = [
                f"{MessageCatalog.translate('取消')}:secondary",
                f"{MessageCatalog.translate('确定')}:primary",
            ]
        else:
...
class QueryDialog(Dialog):
    ...
    def create_buttonbox(self, master):
        ...
        submit = ttk.Button(
            master=frame,
            bootstyle="primary",
            text=MessageCatalog.translate("提交"),
        ...
        cancel = ttk.Button(
            master=frame,
            bootstyle="secondary",
            text=MessageCatalog.translate("取消"),
...
class DatePickerDialog:
    ...
    def _header_columns(self):
        ...
        """
        weekdays = [
            MessageCatalog.translate("周一"),
            MessageCatalog.translate("周二"),
            MessageCatalog.translate("周三"),
            MessageCatalog.translate("周四"),
            MessageCatalog.translate("周五"),
            MessageCatalog.translate("周六"),
            MessageCatalog.translate("周日"),
        ]
...
class FontDialog(Dialog):
    ...
    def __init__(self, title="字体选择", parent=None):
    ...
    def create_buttonbox(self, master):
        ...
        ok_btn = ttk.Button(
            master=container,
            bootstyle="primary",
            text=MessageCatalog.translate("确定"),
    ...
    def _font_families_selector(self, master):
        ...
        header = ttk.Label(
            container,
            text=MessageCatalog.translate("字体"),
            font="TkHeadingFont",
        )
    ...
    def _font_size_selector(self, master):
        ...
        header = ttk.Label(
            container,
            text=MessageCatalog.translate("大小"),
            font="TkHeadingFont",
        )
        header.pack(fill=X, pady=(0, 2), anchor=N)
    ...
    def _font_options_selectors(self, master, padding: int):
        ...
        opt_bold = ttk.Radiobutton(
            master=weight_lframe,
            text=MessageCatalog.translate("较重"),
            value="bold",
            variable=self._weight,
        )
        ...
        slant_lframe = ttk.Labelframe(
            container, text=MessageCatalog.translate("倾斜"), padding=5
        )
        ...
        opt_italic = ttk.Radiobutton(
            master=slant_lframe,
            text=MessageCatalog.translate("倾斜"),
            value="italic",
            variable=self._slant,
        )
    ...
    def _font_preview(self, master, padding: int):
        ...
        header = ttk.Label(
            container,
            text=MessageCatalog.translate("示例"),
            font="TkHeadingFont",
        )
...
class Querybox:
    ...
    def get_font(parent=None, **kwargs):
        ...
        dialog.show(position)
        return (dialog.result, dialog.is_ok)
